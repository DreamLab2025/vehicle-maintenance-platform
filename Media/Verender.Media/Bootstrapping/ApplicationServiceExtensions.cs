...
using Verender.Media.Apis;
using Verender.Media.Application.Configuration;
using Verender.Media.Application.IStorage;
using Verender.Media.Application.Services.Implements;
using Verender.Media.Application.Services.Interfaces;
using Verender.Media.Domain.Repositories.Interfaces;
using Verender.Media.Infrastructure.Configuration;
using Verender.Media.Infrastructure.Data;
using Verender.Media.Infrastructure.Repositories.Implements;
using Verender.Media.Infrastructure.Storage;
using Verender.ServiceDefaults;

namespace Verender.Media.Bootstrapping
{
