...
[System] → Insert OdometerHistory, Update UserVehicle.CurrentOdometer, LastOdometerUpdate
   ↓
[System] → (Đồng bộ) So sánh CurrentOdometer với PredictedNext* → tạo/cập nhật MaintenanceReminder theo level (nhiều bản ghi per part; mặc định lấy level cao nhất). Ngưỡng Level: Urgent <5%, High 5–15%, Medium 15–25%, Low 25–40%.
```
...
**Ngưỡng ReminderLevel** (% còn lại): **Normal** >40%, **Low** 25–40%, **Medium** 15–25%, **High** 5–15%, **Urgent** <5%. Flow: Normal → Low → Medium → High → Urgent → [Thay phụ tùng] → Normal.
...
| Ngưỡng ReminderLevel                    | **Normal** >40%, **Low** 25–40%, **Medium** 15–25%, **High** 5–15%, **Urgent** <5%.             |
