...
public static class NotificationDataSeeder
{
    public static void SeedNotificationData(this ModelBuilder modelBuilder)
    {
        ...
        var templates = new List<NotificationTemplate>
        {
            ...
            new() { Id = Guid.Parse("20000000-0000-0000-0000-000000000001"), Code = "WELCOME_USER", NotificationType = NotificationType.User, IsActive = true, CreatedAt = fixedDate, TitleTemplate = "Chao mung!", MessageTemplate = "Xin chao {UserName} den voi Verender!" },
            new() { Id = Guid.Parse("20000000-0000-0000-0000-000000000002"), Code = "PHONE_VERIFIED", NotificationType = NotificationType.User, IsActive = true, CreatedAt = fixedDate, TitleTemplate = "SDT da xac thuc", MessageTemplate = "SDT {PhoneNumber} da xac thuc." },
