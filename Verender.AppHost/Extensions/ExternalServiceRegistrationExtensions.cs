...
namespace Verender.AppHost.Extensions
{
    public static class ExternalServiceRegistrationExtensions
    {
        public static IDistributedApplicationBuilder AddApplicationServices(this IDistributedApplicationBuilder builder)
        {
            ...
            var vehicleService = builder.AddProject<Projects.Verender_Vehicle>("Verender-vehicle")
                .WithReference(vehicleDb)
                .WithReference(rabbitMq)
                .WaitFor(postgres)
                .WaitFor(rabbitMq);

            var mediaService = builder.AddProject<Projects.Verender_Media>("Verender-media")
