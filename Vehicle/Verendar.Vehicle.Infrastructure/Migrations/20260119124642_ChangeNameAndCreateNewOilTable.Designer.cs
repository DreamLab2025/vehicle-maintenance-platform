...
namespace Verendar.Vehicle.Infrastructure.Migrations
{
    ...
    [Migration("20260119124642_ChangeNameAndCreateNewOilTable")]
    partial class ChangeNameAndCreateNewOilTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.MaintenanceActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.MaintenanceActivityDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.Oil", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("ApiServiceClass")
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)");

                    b.Property<string>("BaseOilType")
                        .HasMaxLength(50)
                    ...
                    b.Property<string>("JasoRating")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)");

                    b.Property<int?>("RecommendedIntervalKmManual")
                        .HasColumnType("integer");

                    b.Property<int?>("RecommendedIntervalKmScooter")
                        .HasColumnType("integer");

                    b.Property<int?>("RecommendedIntervalMonths")
                        .HasColumnType("integer");

                    b.Property<decimal?>("RecommendedVolumeLiters")
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.StandardMaintenanceSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VehicleModelId", "VehiclePartId")
                        .IsUnique();

                    b.ToTable("StandardMaintenanceSchedules");
                });

            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.UserMaintenanceConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.VehiclePart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.VehiclePartCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VehiclePartCategories", (string)null);
                });
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.MaintenanceActivityDetail", b =>
                {
                    b.HasOne("Verendar.Vehicle.Domain.Entities.MaintenanceActivity", "MaintenanceActivity")
                        .WithMany("Details")
                        .HasForeignKey("MaintenanceActivityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Verendar.Vehicle.Domain.Entities.VehiclePart", "VehiclePart")
                        .WithMany("MaintenanceActivityDetails")
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.Oil", b =>
                {
                    b.HasOne("Verendar.Vehicle.Domain.Entities.VehiclePart", "VehiclePart")
                        .WithOne()
                        .HasForeignKey("Verendar.Vehicle.Domain.Entities.Oil", "VehiclePartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.UserMaintenanceConfig", b =>
                {
                    ...
                    b.HasOne("Verendar.Vehicle.Domain.Entities.VehiclePart", "VehiclePart")
                        .WithMany("UserMaintenanceConfigs")
                        .HasForeignKey("VehiclePartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.UserVehicle", b =>
                {
                    b.HasOne("Verendar.Vehicle.Domain.Entities.VehicleModel", null)
                        .WithMany("UserVehicles")
                        .HasForeignKey("VehicleModelId");

                    b.HasOne("Verendar.Vehicle.Domain.Entities.VehicleVariant", "VehicleVariant")
                        .WithMany()
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.VehicleModel", b =>
                {
                    ...
                    b.HasOne("Verendar.Vehicle.Domain.Entities.VehicleType", "Type")
                        .WithMany("VehicleModels")
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.VehiclePart", b =>
                {
                    b.HasOne("Verendar.Vehicle.Domain.Entities.VehiclePartCategory", "Category")
            ...
            modelBuilder.Entity("Verendar.Vehicle.Domain.Entities.VehiclePart", b =>
                {
                    b.Navigation("MaintenanceActivityDetails");

                    b.Navigation("StandardMaintenanceSchedules");

                    b.Navigation("UserMaintenanceConfigs");
                });
