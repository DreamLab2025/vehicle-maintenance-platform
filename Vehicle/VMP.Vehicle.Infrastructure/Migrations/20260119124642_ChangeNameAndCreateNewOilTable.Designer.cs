...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.Oil", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.VehiclePart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.VehiclePartCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.VehicleVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.MaintenanceActivityDetail", b =>
                {
                    ...
                    b.HasOne("VMP.Vehicle.Domain.Entities.VehiclePart", "VehiclePart")
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.Oil", b =>
                {
                    b.HasOne("VMP.Vehicle.Domain.Entities.VehiclePart", "VehiclePart")
                        .WithOne()
                        .HasForeignKey("VMP.Vehicle.Domain.Entities.Oil", "VehiclePartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.UserVehicle", b =>
                {
                    b.HasOne("VMP.Vehicle.Domain.Entities.VehicleModel", null)
                        .WithMany("UserVehicles")
                        .HasForeignKey("VehicleModelId");

                    b.HasOne("VMP.Vehicle.Domain.Entities.VehicleVariant", "VehicleVariant")
                        .WithMany()
            ...
            modelBuilder.Entity("VMP.Vehicle.Domain.Entities.VehiclePart", b =>
                {
                    b.HasOne("VMP.Vehicle.Domain.Entities.VehiclePartCategory", "Category")
